...
- Check the [content error logs](https://learn.microsoft.com/minecraft/creator/documents/contenterrorlog?view=minecraft-bedrock-stable) for detected problems that could cause instability or unpredictable behavior.
