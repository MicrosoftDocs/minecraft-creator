...
:::image type="content" source="Media/MinecraftEntityWizard/MinecraftEntityWizard.png" alt-text="Image showcasing the Minecraft Entity Wizard start up page. Contains a single button marked Let's Go":::
