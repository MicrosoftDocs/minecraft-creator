...
> [!NOTE]
> Animations can also use Molang expressions to display visual changes in an entity over time. Sometimes Molang expressions can even be used instead of explicit keyframes. To learn more about Molang expressions, see [A first look at Molang](MolangBeginnersGuide.md)
