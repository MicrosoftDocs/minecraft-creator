...
> [!VIDEO https://youtu.be/dVXA98kI9c0]
...
> [!VIDEO https://youtu.be/57sLxXDkaA0]
...
There are a lot of moving parts to this feature, so it might be worth taking a look at the [Jigsaw - Basic Dungeon sample pack](https://github.com/microsoft/minecraft-samples/tree/main/jigsaws/basic_dungeon) companion document that goes along with the video. We're going to create structures, put Jigsaw blocks in the structures, save the structures with structure blocks, and then use a behavior pack to configure jigsaw blocks to generate a super-structure no one has ever seen before!
...
1. If you don't want to do everything from scratch, you can start with the [behavior_pack_sample](https://github.com/microsoft/minecraft-samples/tree/main/behavior_pack_sample) from the Minecraft samples on GitHub.
    > [!NOTE]
    > This behavior pack is significantly more involved than the starter ["Angry Cow" behavior pack](../BehaviorPack.md).

2. Download the "angry cow" sample behavior pack, pop it into **development_behavior_pack** innside your **com.mojang** folder.
    > [!NOTE]
    > You won't need a resource pack for this sample.

3. (Optional) Create a survival world, find a cow, confirm that the cow is indeed very angry, then save and close the world.

4. Make sure you know how to get back to your behavior pack files. We're going to edit them and do lots of experimentation.

### Creating Jigsaw Structures

1. For the easiest creation experience, make another world in Minecraft. The new world should be launched in creative mode, with no mobs, no weather, no daylight cycles, cheats toggled on, and the **Data-Driven Jigsaw Structures** experiment toggled on.

2. After you create your smaller structures, put jigsaw blocks on the sides where you want them to connect with other structures.
...
2. Add the four **worldgen** folders and files so that the behavior pack looks like this:
...
#### [structures/<mystructure>.json](../../Reference/Content/WorldgenReference/Examples/JigsawJigsawStructures.md)
...
#### [processors/<mystructureprocessor>.json](./../../Reference/Content/WorldgenReference/Examples/JigsawProcessors.md)
...
#### [structure_sets/<mystructureset>.json](../../Reference/Content/WorldgenReference/Examples/JigsawStructureSets.md)
...
#### [template_pools/<mytemplatepool>.json](../../Reference/Content/WorldgenReference/Examples/JigsawTemplatePools.md)
...
1. First, open your world where you build your original structures so you can build and save whatever additional walls and interior features you want placed in them.
