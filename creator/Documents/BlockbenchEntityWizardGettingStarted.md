...
:::image type="content" source="Media/BlockbenchEntityWizardGettingStarted/BlockbenchEntityWizard.png" alt-text="Image showcasing the Blockbench Entity Wizard start up page. Contains a single button labed "Let's Go"":::
