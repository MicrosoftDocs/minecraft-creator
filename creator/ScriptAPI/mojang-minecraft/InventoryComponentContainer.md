...
Adds an item to the specified container. Items will be placed in the first available empty slot. (Use @Minecraft.InventoryComponentContainer.setItem if you wish to set items in a particular slot.)
#### Arguments
