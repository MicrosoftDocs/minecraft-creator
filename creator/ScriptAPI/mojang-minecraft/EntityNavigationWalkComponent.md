...
ms.author: jashir
ms.prod: gaming
title: mojang-minecraft.EntityNavigationWalkComponent Class
description: Contents of the mojang-minecraft.EntityNavigationWalkComponent class.
---
...
### **id**
`static read-only id = "minecraft:navigation.walk";`
