...
### **stoneBlockSlab**
`static read-only stoneBlockSlab: ItemType;`

Type: [*ItemType*](ItemType.md)

### **stoneBlockSlab2**
`static read-only stoneBlockSlab2: ItemType;`

Type: [*ItemType*](ItemType.md)

### **stoneBlockSlab3**
`static read-only stoneBlockSlab3: ItemType;`

Type: [*ItemType*](ItemType.md)

### **stoneBlockSlab4**
`static read-only stoneBlockSlab4: ItemType;`
