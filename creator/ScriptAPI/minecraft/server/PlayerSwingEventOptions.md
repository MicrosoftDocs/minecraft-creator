...
An interface that is passed into [*@minecraft/server.PlayerSwingStartAfterEventSignal.subscribe*](../../../scriptapi/minecraft/server/PlayerSwingStartAfterEventSignal.md#subscribe) that filters out which events are passed to the provided callback.
