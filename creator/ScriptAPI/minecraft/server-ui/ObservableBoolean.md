...
ms.date: 02/10/2025
title: minecraft/server-ui.ObservableBoolean Class
description: Contents of the @minecraft/server-ui.ObservableBoolean class.
---
# ObservableBoolean Class
...
### **constructor**
`
new ObservableBoolean(data: boolean, options?: ObservableOptions)
`

Creates a new ObservableBoolean with the provided initial boolean value.
...
**Returns** [*ObservableBoolean*](ObservableBoolean.md)
