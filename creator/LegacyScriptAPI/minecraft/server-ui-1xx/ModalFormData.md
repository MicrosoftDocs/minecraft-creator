...
#### **Parameters**
- **label**: [*@minecraft/server.RawMessage*](../../../legacyscriptapi/minecraft/server-1xx/RawMessage.md) | *string*
  
  The label to display for the dropdown.
- **options**: ([*@minecraft/server.RawMessage*](../../../legacyscriptapi/minecraft/server-1xx/RawMessage.md) | *string*)[]
...
#### **Parameters**
- **player**: [*@minecraft/server.Player*](../../../legacyscriptapi/minecraft/server-1xx/Player.md)
...
- This function can throw errors.
  - Throws [*@minecraft/common.EngineError*](../../../scriptapi/minecraft/common/EngineError.md), [*@minecraft/server.InvalidEntityError*](../../../legacyscriptapi/minecraft/server-1xx/InvalidEntityError.md), [*@minecraft/server.RawMessageError*](../../../legacyscriptapi/minecraft/server-1xx/RawMessageError.md)
...
#### **Parameters**
- **submitButtonText**: [*@minecraft/server.RawMessage*](../../../legacyscriptapi/minecraft/server-1xx/RawMessage.md) | *string*
...
- **placeholderText**: [*@minecraft/server.RawMessage*](../../../legacyscriptapi/minecraft/server-1xx/RawMessage.md) | *string*
  
  The place holder text to display.
- **defaultValue**?: [*@minecraft/server.RawMessage*](../../../legacyscriptapi/minecraft/server-1xx/RawMessage.md) | *string* = `null`
...
#### **Parameters**
- **titleText**: [*@minecraft/server.RawMessage*](../../../legacyscriptapi/minecraft/server-1xx/RawMessage.md) | *string*
