...
- **componentId**: *T*
  ...
  The identifier of the component (e.g., 'minecraft:food'). If no namespace prefix is specified, 'minecraft:' is assumed. Available component IDs are those in the [*@minecraft/server.ItemComponentTypes*](../../../legacyscriptapi/minecraft/server-1xx/ItemComponentTypes.md) enum and custom component IDs registered with the [*@minecraft/server.ItemComponentRegistry*](../../../legacyscriptapi/minecraft/server-1xx/ItemComponentRegistry.md).
