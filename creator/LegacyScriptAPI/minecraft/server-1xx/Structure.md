...
Represents a loaded structure template (.mcstructure file). Structures can be placed in a world using the /structure command or the [*@minecraft/server.StructureManager*](../../../legacyscriptapi/minecraft/server-1xx/StructureManager.md) APIs.
