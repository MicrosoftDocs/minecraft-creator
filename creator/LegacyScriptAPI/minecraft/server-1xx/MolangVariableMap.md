...
- `<variable_name>.direction_x` - X value from the [*@minecraft/server.Vector3*](../../../legacyscriptapi/minecraft/server-1xx/Vector3.md) provided

- `<variable_name>.direction_y` - Y value from the [*@minecraft/server.Vector3*](../../../legacyscriptapi/minecraft/server-1xx/Vector3.md) provided

- `<variable_name>.direction_z` - Z value from the [*@minecraft/server.Vector3*](../../../legacyscriptapi/minecraft/server-1xx/Vector3.md) provided
...
- `<variable_name>.x` - X value from the [*@minecraft/server.Vector3*](../../../legacyscriptapi/minecraft/server-1xx/Vector3.md) provided

- `<variable_name>.y` - Y value from the [*@minecraft/server.Vector3*](../../../legacyscriptapi/minecraft/server-1xx/Vector3.md) provided

- `<variable_name>.z` - Z value from the [*@minecraft/server.Vector3*](../../../legacyscriptapi/minecraft/server-1xx/Vector3.md) provided
