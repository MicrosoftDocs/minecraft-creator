...
Returns the manager for [*@minecraft/server.Structure*](../../../legacyscriptapi/minecraft/server-1xx/Structure.md) related APIs.
...
Notes:
- This function can throw errors.
  - This method can throw if the provided [*@minecraft/server.RawMessage*](../../../legacyscriptapi/minecraft/server-1xx/RawMessage.md) is in an invalid format. For example, if an empty `name` string is provided to `score`.
