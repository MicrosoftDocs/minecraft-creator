...
Input permission categories. Used by [*@minecraft/server.PlayerInputPermissionCategoryChangeAfterEvent*](../../../legacyscriptapi/minecraft/server-1xx/PlayerInputPermissionCategoryChangeAfterEvent.md) to specify which category was changed and [*@minecraft/server.PlayerInputPermissions*](../../../legacyscriptapi/minecraft/server-1xx/PlayerInputPermissions.md) to get or set permissions.
