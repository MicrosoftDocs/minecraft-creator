...
Cancels the execution of a job queued via [*@minecraft/server.System.runJob*](../../../legacyscriptapi/minecraft/server-1xx/System.md#runjob).

#### **Parameters**
- **jobId**: *number*
  
  The job ID returned from [*@minecraft/server.System.runJob*](../../../legacyscriptapi/minecraft/server-1xx/System.md#runjob).
...
Cancels the execution of a function run that was previously scheduled via [*@minecraft/server.System.run*](../../../legacyscriptapi/minecraft/server-1xx/System.md#run).
...
**Returns** *number* - An opaque handle that can be used with [*@minecraft/server.System.clearJob*](../../../legacyscriptapi/minecraft/server-1xx/System.md#clearjob) to stop the run of this generator.
