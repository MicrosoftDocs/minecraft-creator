...
Creates an empty Structure in memory. Use [*@minecraft/server.Structure.setBlockPermutation*](../../../legacyscriptapi/minecraft/server-1xx/Structure.md#setblockpermutation) to populate the structure with blocks and save changes with [*@minecraft/server.Structure.saveAs*](../../../legacyscriptapi/minecraft/server-1xx/Structure.md#saveas).
...
**Returns** [*BlockBoundingBox*](BlockBoundingBox.md) - Returns a [*@minecraft/server.BlockBoundingBox*](../../../legacyscriptapi/minecraft/server-1xx/BlockBoundingBox.md) object which represents the maximum bounds of the jigsaw structure.
