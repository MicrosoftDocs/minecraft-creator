...
This event fires when an [*@minecraft/server.InputButton*](../../../legacyscriptapi/minecraft/server-1xx/InputButton.md) state is changed.
...
This event fires when a player's [*@minecraft/server.InputMode*](../../../legacyscriptapi/minecraft/server-1xx/InputMode.md) changes.
