...
has a size of ( 0,0,0 ) (unlike the very similar [*@minecraft/server.BlockVolume*](../../../legacyscriptapi/minecraft/server-1xx/BlockVolume.md) object)
...
A [*@minecraft/server.Vector3*](../../../legacyscriptapi/minecraft/server-1xx/Vector3.md) that represents the largest corner of the rectangle
...
A [*@minecraft/server.Vector3*](../../../legacyscriptapi/minecraft/server-1xx/Vector3.md) that represents the smallest corner of the rectangle
