...
Identifier of the type of the entity - for example, 'minecraft:skeleton'. This property is accessible even if [*@minecraft/server.Entity.isValid*](../../../legacyscriptapi/minecraft/server-1xx/Entity.md#isvalid) is false.
...
- **duration**: *number*
  ...
  Amount of time, in ticks, for the effect to apply. There are 20 ticks per second. Use [*@minecraft/server.TicksPerSecond*](../../../legacyscriptapi/minecraft/server-1xx/minecraft-server.md#tickspersecond) constant to convert between ticks and seconds. The value must be within the range [0, 20000000].
...
- **componentId**: *T*
  ...
  The identifier of the component (e.g., 'minecraft:health'). If no namespace prefix is specified, 'minecraft:' is assumed. Available component IDs can be found as part of the [*@minecraft/server.EntityComponentTypes*](../../../legacyscriptapi/minecraft/server-1xx/EntityComponentTypes.md) enum.
