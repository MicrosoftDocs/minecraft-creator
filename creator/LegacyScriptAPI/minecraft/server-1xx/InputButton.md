...
All the different input buttons that are supported. Use with [*@minecraft/server.InputInfo.getButtonState*](../../../legacyscriptapi/minecraft/server-1xx/InputInfo.md#getbuttonstate) via [*@minecraft/server.Player.inputInfo*](../../../legacyscriptapi/minecraft/server-1xx/Player.md#inputinfo) or [*@minecraft/server.PlayerButtonInputAfterEvent*](../../../legacyscriptapi/minecraft/server-1xx/PlayerButtonInputAfterEvent.md) via [*@minecraft/server.WorldAfterEvents.playerButtonInput*](../../../legacyscriptapi/minecraft/server-1xx/WorldAfterEvents.md#playerbuttoninput)
