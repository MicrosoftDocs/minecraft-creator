...
Enumerates all [*@minecraft/server.BlockStateType*](../../../legacyscriptapi/minecraft/server-1xx/BlockStateType.md)s.
...
**Returns** [*BlockStateType*](BlockStateType.md) | *undefined* - Returns the [*@minecraft/server.Block*](../../../legacyscriptapi/minecraft/server-1xx/Block.md) state instance if it is found. If the block state instance is not found returns undefined.
