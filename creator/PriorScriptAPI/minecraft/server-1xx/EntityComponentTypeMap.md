...
ms.date: 02/10/2025
title: minecraft/server-1xx.EntityComponentTypeMap Type Alias
description: Contents of the @minecraft/server.EntityComponentTypeMap type alias (Version 1.x.x).
---
# EntityComponentTypeMap Type Alias (Version 1.x.x)

> [!IMPORTANT]
> This documentation is for an older version of this module. Go to the latest documentation [*here*](../../../scriptapi/minecraft/server/EntityComponentTypeMap.md).
