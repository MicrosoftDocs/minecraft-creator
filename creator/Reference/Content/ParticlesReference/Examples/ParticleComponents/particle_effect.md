...
**JSON path:** `components > minecraft:emitter_initialization`
...
**JSON path:** `components > minecraft:emitter_lifetime_expression`
...
**JSON path:** `components > minecraft:emitter_lifetime_looping`
...
**JSON path:** `components > minecraft:emitter_lifetime_once`
...
**JSON path:** `components > minecraft:emitter_rate_instant`
...
**JSON path:** `components > minecraft:emitter_rate_manual`
...
**JSON path:** `components > minecraft:emitter_rate_steady`
...
**JSON path:** `components > minecraft:emitter_shape_box`
...
**JSON path:** `components > minecraft:emitter_shape_custom`
...
**JSON path:** `components > minecraft:emitter_shape_disc`
...
**JSON path:** `components > minecraft:emitter_shape_entity_aabb`
...
**JSON path:** `components > minecraft:emitter_shape_sphere`
...
**JSON path:** `components > minecraft:particle_appearance_billboard`
...
**JSON path:** `components > minecraft:particle_appearance_tinting`
...
**JSON path:** `components > minecraft:particle_appearance_tinting > color`
...
**JSON path:** `components > minecraft:particle_initial_spin`
...
**JSON path:** `components > minecraft:particle_initialization`
...
**JSON path:** `components > minecraft:particle_lifetime_expression`
...
**JSON path:** `components > minecraft:particle_motion_collision`
...
**JSON path:** `components > minecraft:particle_motion_collision > events`
...
**JSON path:** `components > minecraft:particle_motion_dynamic`
...
**JSON path:** `components > minecraft:particle_motion_parametric`
...
**JSON path:** `description > basic_render_parameters`
...
**JSON path:** `events > particle_effect`
...
**JSON path:** `events > randomize > sound_effect`
