...
author: mammerla
ms.author: mikeam
title: "Particles Documentation - minecraft:particle_document"
description: "Describes the minecraft:particle_document particle component"
...
A resource pack particle effect definition document for Minecraft Bedrock Edition. This describes the complete JSON file structure including format_version and the particle_effect wrapper. Particles use a component-based system with emitters controlling spawn rate and shape, and particle components controlling appearance and motion.


## Particle Effect Document Properties

|Name       |Default Value |Type |Description |
|:----------|:-------------|:----|:-----------|
| format_version | *not set* | Version | The format version of this particle effect file. Use '1.10.0' or later for the modern particle system. | 
| particle_effect | *not set* | [Particle Effect](#particle-effect) item | The particle effect definition containing description and components. | 
...
**JSON path:** `particle_effect > components`
...
**JSON path:** `particle_effect > components > minecraft:emitter_initialization`
...
**JSON path:** `particle_effect > components > minecraft:emitter_lifetime_expression`
...
**JSON path:** `particle_effect > components > minecraft:emitter_lifetime_expression > activation_expression`
...
**JSON path:** `particle_effect > components > minecraft:emitter_lifetime_looping`
...
**JSON path:** `particle_effect > components > minecraft:emitter_lifetime_looping > active_time`
...
**JSON path:** `particle_effect > components > minecraft:emitter_lifetime_once`
...
**JSON path:** `particle_effect > components > minecraft:emitter_rate_instant`
...
**JSON path:** `particle_effect > components > minecraft:emitter_rate_instant > num_particles`
...
**JSON path:** `particle_effect > components > minecraft:emitter_rate_manual`
...
**JSON path:** `particle_effect > components > minecraft:emitter_rate_manual > max_particles`
...
**JSON path:** `particle_effect > components > minecraft:emitter_rate_steady`
...
**JSON path:** `particle_effect > components > minecraft:emitter_rate_steady > spawn_rate`
...
**JSON path:** `particle_effect > components > minecraft:emitter_shape_box`
...
**JSON path:** `particle_effect > components > minecraft:emitter_shape_box > half_dimensions`
...
**JSON path:** `particle_effect > components > minecraft:emitter_shape_custom`
...
**JSON path:** `particle_effect > components > minecraft:emitter_shape_custom > direction`
...
**JSON path:** `particle_effect > components > minecraft:emitter_shape_disc`
...
**JSON path:** `particle_effect > components > minecraft:emitter_shape_disc > radius`
...
**JSON path:** `particle_effect > components > minecraft:emitter_shape_entity_aabb`
...
**JSON path:** `particle_effect > components > minecraft:emitter_shape_sphere`
...
**JSON path:** `particle_effect > components > minecraft:particle_appearance_billboard`
...
**JSON path:** `particle_effect > components > minecraft:particle_appearance_billboard > size`
...
**JSON path:** `particle_effect > components > minecraft:particle_appearance_tinting`
...
**JSON path:** `particle_effect > components > minecraft:particle_appearance_tinting > color`
...
**JSON path:** `particle_effect > components > minecraft:particle_initial_spin`
...
**JSON path:** `particle_effect > components > minecraft:particle_initial_spin > rotation`
...
**JSON path:** `particle_effect > components > minecraft:particle_initialization`
...
**JSON path:** `particle_effect > components > minecraft:particle_initialization > per_render_expression`
...
**JSON path:** `particle_effect > components > minecraft:particle_lifetime_expression`
...
**JSON path:** `particle_effect > components > minecraft:particle_lifetime_expression > max_lifetime`
...
**JSON path:** `particle_effect > components > minecraft:particle_motion_collision`
...
**JSON path:** `particle_effect > components > minecraft:particle_motion_collision > enabled`
...
**JSON path:** `particle_effect > components > minecraft:particle_motion_dynamic`
...
**JSON path:** `particle_effect > components > minecraft:particle_motion_dynamic > linear_acceleration`
...
**JSON path:** `particle_effect > components > minecraft:particle_motion_parametric`
...
**JSON path:** `particle_effect > components > minecraft:particle_motion_parametric > relative_position`
...
**JSON path:** `particle_effect > curves`
...
**JSON path:** `particle_effect > curves > horizontal_range`
...
**JSON path:** `particle_effect > description`
...
**JSON path:** `particle_effect > description > basic_render_parameters`
...
**JSON path:** `particle_effect > events`
...
**JSON path:** `particle_effect > events > expression`
...
**JSON path:** `particle_effect > events > particle_effect`
...
**JSON path:** `particle_effect > events > particle_effect > pre_effect_expression`
...
**JSON path:** `particle_effect > events > randomize`
...
**JSON path:** `particle_effect > events > randomize > sound_effect`
