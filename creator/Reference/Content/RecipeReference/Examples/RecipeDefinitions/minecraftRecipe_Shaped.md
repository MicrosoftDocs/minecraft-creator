...
`assume_symmetry` is an optional field.  If not set, it will default to `true`.  If it is set to true, then Minecraft will assume the symmetrical version of your recipe is valid when using the crafting table.  This is the default behavior.  By setting it to false, you can define mirrored versions of a recipe and have different results.
