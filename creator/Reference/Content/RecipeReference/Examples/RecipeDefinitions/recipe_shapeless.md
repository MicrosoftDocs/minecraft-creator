...
**JSON path:** `minecraft:recipe_shapeless`
...
**JSON path:** `minecraft:recipe_shapeless > description`
...
**JSON path:** `minecraft:recipe_shapeless > ingredients`
...
**JSON path:** `minecraft:recipe_shapeless > result`
...
**JSON path:** `minecraft:recipe_shapeless > unlock`
