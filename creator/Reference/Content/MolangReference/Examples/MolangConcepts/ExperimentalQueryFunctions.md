...
| Name| Description |
|:-----------|:-----------|
| query.actor_property| (EXPERIMENTAL. Enable **Holiday Creator Features** AND **Upcoming Creator Features** to use.) Takes one argument: the name of the property on the entity. Returns the value of that property if it exists, else it returns 0.0. |
