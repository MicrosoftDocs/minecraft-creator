...
|:-----|:----------|
| [Add Rider](EntityComponents/minecraftComponent_addrider.md)| Adds a rider to the entity. |
...
| [Ageable](EntityComponents/minecraftComponent_ageable.md)| Adds a timer for the entity to grow up. |
| [Ambient Sound Interval](EntityComponents/minecraftComponent_ambient_sound_interval.md)| Delay for an entity playing its sound |
| [Anger Level](EntityComponents/minecraftComponent_anger_level.md)| Compels the entity to track anger towards a set of nuisances. |
| [Angry](EntityComponents/minecraftComponent_angry.md)| Defines an entity's 'angry' state using a timer. |
| [Break doors annotation](EntityComponents/minecraftComponent_annotation_break_door.md)| Allows an entity to break doors, assuming that that flags set up for the component to use in navigation. |
| [Open doors annotation](EntityComponents/minecraftComponent_annotation_open_door.md)| Allows the entity to open doors. |
| [Area Attack](EntityComponents/minecraftComponent_area_attack.md)| A component that does damage to entities that get within range. |
| [Attack](EntityComponents/minecraftComponent_attack.md)| Allows an entity to define an entity's melee attack and any additional effects on it's attack. |
| [Attack Cooldown](EntityComponents/minecraftComponent_attack_cooldown.md)| Adds a cooldown to an entity. |
...
| [Barter](EntityComponents/minecraftComponent_barter.md)| Enables the component to drop an item as a barter exchange. |
...
| [Boostable](EntityComponents/minecraftComponent_boostable.md)| Defines the conditions and behavior of a rideable entity's boost. |
| [Boss](EntityComponents/minecraftComponent_boss.md)| Defines the current state of the boss for updating the boss HUD. |
| [Break Blocks](EntityComponents/minecraftComponent_break_blocks.md)| Specifies the blocks that the entity can break as it moves around. |
| [Breathable](EntityComponents/minecraftComponent_breathable.md)| Defines what blocks this entity can breathe in and gives them the ability to suffocate. |
| [Breedable](EntityComponents/minecraftComponent_breedable.md)| Allows an entity to establish a way to get into the love state used for breeding. |
...
| [Collision Box](EntityComponents/minecraftComponent_collision_box.md)| Sets the width and height of the Entity's collision box. |
...
| [Healable](EntityComponents/minecraftComponent_healable.md)| How entities heal |
...
| [Leashable](EntityComponents/minecraftComponent_leashable.md)| Describes how this mob can be leashed to other items |
...
| [Mark Variant](EntityComponents/minecraftComponent_mark_variant.md)| Mark Variant is typically used as an additional per-type way (besides `variant`) to express a different visual form of the same mob. |
...
| [Fly Movement](EntityComponents/minecraftComponent_movement.fly.md)| This move control causes the mob to fly. |
...
| [Walk navigation](EntityComponents/minecraftComponent_navigation.walk.md)| Walking style of the mob |
...
| [Rideable](EntityComponents/minecraftComponent_rideable.md)| This entity can be ridden |
...
| [Scheduler](EntityComponents/minecraftComponent_scheduler.md)| Fires off scheduled mob events at time of day events. |
...
| [Shooter](EntityComponents/minecraftComponent_shooter.md)| Defines the entity's ranged attack behavior. |
...
| [Tameable](EntityComponents/minecraftComponent_tameable.md)| This entity can be tamed |
...
| [Type Family](EntityComponents/minecraftComponent_type_family.md)| Defines the families this entity belongs to. |
...
| [Variant](EntityComponents/minecraftComponent_variant.md)| Variant is typically used as a per-type way to express a different visual form of the same mob. |
