...
| test | *not set* | String |  | Bogged: `"is_difficulty"` | 
| value | *not set* | [Value](#value-choices) choices | (Required) The game's difficulty level to test | Bogged: `"hard"`, Cave Spider: `"easy"`, `"normal"` | 
