...
|:----------|:-------------|:----|:-----------|:------------- |
| event | *not set* | String | The event to run when the conditions for this trigger are met. | Polar Bear: `"minecraft:on_anger"`, Trader Llama: `"minecraft:defend_wandering_trader"` | 
