...
| cooldown_range | {"max":20,"min":10} | [Cooldown Range](#legacy-floatrange) item | Minimum and maximum cooldown time-range (positive, in seconds) between each attempted jump. | Frog: `{"min":5,"max":7}`, Goat: `[30,60]` | 
| forbidden_blocks | [] | String | Blocks that the mob can't jump to. | Frog: `[{"name":"minecraft:water"}]` | 
...
| preferred_blocks | [] | String | Blocks that the mob prefers jumping to. | Frog: `[{"name":"minecraft:waterlily"},{"name":"minecraft:big_dripleaf"}]` | 
