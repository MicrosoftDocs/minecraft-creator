...
| on_kill | *not set* | [Minecraft Event Trigger](../Definitions/NestedTables/triggers.md) | Defines the event to trigger when this entity kills the target. | Axolotl: `{"event":"killed_enemy_event","target":"self"}` | 
