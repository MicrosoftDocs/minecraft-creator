...
## Entity Defend Trusted Target Behavior Properties

|Name       |Default Value |Type |Description |
|:----------|:-------------|:----|:-----------|
| aggro_sound | undefined | [Aggro Sound](#aggro-sound-choices) choices | Sound to occasionally play while defending. | 
...
| on_defend_start | {"event":"","filters":{"AND":null,"NOT":null,"OR":null,"all":null,"all_of":null,"any":null,"any_of":null,"none_of":null},"target":"self"} | [Defend Start](#entity-actordefinitiontrigger) item | Trigger to be executed when defending begins. | 
