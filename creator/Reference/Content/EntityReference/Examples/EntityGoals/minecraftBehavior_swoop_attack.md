...
|:----------|:-------------|:----|:-----------|:------------- |
| damage_reach | 0.2 | Decimal number | Added to the base size of the entity, to determine the target's maximum allowable distance, when trying to deal attack damage. |  | 
| delay_range | *not set* | Range of integers | Minimum and maximum cooldown time-range (in seconds) between each attempted swoop attack. |  | 
