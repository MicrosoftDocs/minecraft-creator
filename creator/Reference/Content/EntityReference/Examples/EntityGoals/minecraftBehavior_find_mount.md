...
| max_failed_attempts | 20 | Integer number | Number of attempts to find mount |  | 
...
| start_delay | 0 | Integer number | Time the mob will wait before starting to move towards the mount | Parrot: `100` | 
| target_needed | false | Boolean true/false | If true, the mob will only look for a mount if it has a target |  | 
| within_radius | 0 | Decimal number | Distance in blocks within which the mob will look for a mount | Parrot: `16` | 
