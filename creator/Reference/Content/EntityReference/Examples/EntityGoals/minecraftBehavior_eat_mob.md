...
| eat_mob_sound |  | String | Sets the sound that should play when eating a mob. | Frog: `"tongue"` | 
| loot_table |  | String | The loot table for loot to be dropped when eating a mob. | Frog: `"loot_tables/entities/frog.json"` | 
| priority | 0 | Integer number | As priority approaches 0, the priority is increased. The higher the priority, the sooner this behavior will be executed as a goal. | Frog: `7` | 
