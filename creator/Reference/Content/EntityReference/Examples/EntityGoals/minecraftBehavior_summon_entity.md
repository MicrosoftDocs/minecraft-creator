...
| summon_choices | [] | Array of [Summon Choices](#entity-summonactorgoaldefinition-spelldata) items | List of spells for the mob to use to summon entities. | 
...
### Entity SummonActorGoalDefinition SpellData

#### Entity SummonActorGoalDefinition SpellData Properties

**JSON path:** `summon_choices`

|Name       |Default Value |Type |Description |
|:----------|:-------------|:----|:-----------|
| cast_duration | -1 | Decimal number | Time in seconds the spell casting will take | 
...
| particle_color | [255, 255, 255, 255] | String | The color of the particles for this spell | 
| particle_color (as Array of numbers) | *not set* | Array of numbers |  | 
| sequence | [] | Array of [Sequence](#entity-summonactorgoaldefinition-spellstage) items | List of steps for the spell. Each step has the following parameters: | 
| start_sound_event | undefined | [Start Sound Event](#sound-event-choices) choices | The sound event to play when using this spell | 
...
**JSON path:** `summon_choices > filters`
...
#### Entity SummonActorGoalDefinition SpellStage

##### Entity SummonActorGoalDefinition SpellStage Properties

**JSON path:** `summon_choices > sequence`
...
| shape | line | [Shape](#shape-choices) choices | The base shape of this step. Valid values are circle and line | 
| size | 1 | Decimal number | The base size of the entity | 
| sound_event | undefined | [Sound Event](#sound-event-choices) choices | The sound event to play for this step | 
...
| target | self | [Target](#target-choices) choices | The target of the spell. This is where the spell will start (line will start here, circle will be centered here) | 
