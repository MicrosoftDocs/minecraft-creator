...
|:----------|:-------------|:----|:-----------|
| avoid_block_sound | undefined | [Avoid Block Sound](#avoid-block-sound-choices) choices | The sound event to play when the mob is avoiding a block. | 
| control_flags | [] | [Control Flags](#control-flags-choices) choices |  | 
| on_escape | [] | [Escape](#entity-actordefinitiontrigger) item | Event triggers that fire when the entity escapes from the avoided block. Can be a single trigger or an array of triggers. | 
...
| tick_interval | 1 | Integer number | Should start tick interval. | 
| walk_speed_modifier | 1 | Decimal number | Modifier for walking speed. 1.0 means keep the regular speed, while higher numbers make the walking speed faster. | 
