...
| priority | *not set* | Integer number | As priority approaches 0, the priority is increased. The higher the priority, the sooner this behavior will be executed as a goal. | Hoglin: `1` | 
...
| sound_interval | *not set* | Range of integers | The range of time in seconds to randomly wait before playing the sound again. | Hoglin: `{"min":2,"max":5}` | 
...
| target_blocks | *not set* | Array of strings | List of block types this mob avoids. | Hoglin: `["minecraft:warped_fungus","minecraft:portal","minecraft:respawn_anchor"]` | 
