...
|:----------|:-------------|:----|:-----------|:------------- |
| can_nap_filters | *not set* | [Can Nap Filters](#can-nap-filters) item | Conditions that need to be met for the entity to nap. | Fox: `{"all_of":[{"test":"in_water","subject":"self","operator":"==","value":false},{"test":"on_ground","subject":"self","operator":"==","value":true},{"test":"is_underground","subject":"self","operator":"==","value":true},{"test":"weather_at_position","subject":"self","operator":"!=","value":"thunderstorm"}]}` | 
...
| wake_mob_exceptions | *not set* | [Wake Mob Exceptions](#wake-mob-exceptions) item | Filters for mobs that will not wake this entity from napping. | Fox: `{"any_of":[{"test":"trusts","subject":"other","operator":"==","value":true},{"test":"is_family","subject":"other","operator":"==","value":"fox"},{"test":"is_sneaking","subject":"other","operator":"==","value":true}]}` | 
