...
## Entity Move To Lava Behavior Properties
...
| search_height | 1 | Integer number | Height in blocks the mob will look for lava to move towards Value must be > 0. | 
| search_range | 0 | Integer number | The distance in blocks it will look for lava to move towards Value must be > 0. | 
