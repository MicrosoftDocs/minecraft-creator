...
## Entity Charge Attack Behavior Properties
...
| priority | 0 | Integer number | As priority approaches 0, the priority is increased. The higher the priority, the sooner this behavior will be executed as a goal. | Vex: `4` | 
| sound_event | charge | [Sound Event](#sound-event-choices) choices |  |  | 
| speed_multiplier | 1 | Decimal number | Modifies the entity's speed when charging toward the target. |  | 
| success_rate | 0.1428000032901764 | Decimal number | Percent chance this entity will start a charge attack, if not already attacking (1.0 = 100%). |  | 
