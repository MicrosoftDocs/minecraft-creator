...
| charge_cooldown_time | {"max":6,"min":2} | [Charge Cooldown Time](#legacy-floatrange) item | Range of time in seconds to wait before starting another charge. Check that the limits imposed on the range (minimum, maximum and maximum distance between values) are respected | 
