...
## Entity Timer Flag 3 Behavior Properties
...
| on_end | {"event":"","filters":{"AND":null,"NOT":null,"OR":null,"all":null,"all_of":null,"any":null,"any_of":null,"none_of":null},"target":"self"} | [End](#entity-actordefinitiontrigger) item | Event(s) to run when the goal ends. | Sniffer: `{"event":"on_feeling_happy_end","target":"self"}` | 
