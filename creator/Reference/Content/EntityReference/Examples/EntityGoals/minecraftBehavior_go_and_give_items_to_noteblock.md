...
## Entity Go And Give Items To Noteblock Behavior Properties
...
| on_item_throw | [] | Array of [Item Throw](#entity-actordefinitiontrigger) items | Event(s) to run when this mob throws items. | Allay: `[{"event":"pickup_item_delay","target":"self"}]` | 
| priority | 0 | Integer number | As priority approaches 0, the priority is increased. The higher the priority, the sooner this behavior will be executed as a goal. | Allay: `3` | 
...
| throw_force | 0.20000000298023224 | Decimal number | Sets the throw force. |  | 
| throw_sound | charge | [Throw Sound](#throw-sound-choices) choices | Sound to play when this mob throws an item. | Allay: `"item_thrown"` | 
...
**JSON path:** `on_item_throw > filters`
