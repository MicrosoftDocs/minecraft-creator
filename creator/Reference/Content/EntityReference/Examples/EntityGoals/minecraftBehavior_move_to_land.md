...
|:----------|:-------------|:----|:-----------|:------------- |
| goal_radius | 0.5 | Decimal number | Distance in blocks within the mob considers it has reached the goal. This is the "wiggle room" to stop the AI from bouncing back and forth trying to reach a specific spot | Frog: `2` | 
...
| search_height | 1 | Integer number | Height in blocks the mob will look for land to move towards | Frog: `8` | 
| search_range | 0 | Integer number | The distance in blocks it will look for land to move towards | Frog: `30` | 
