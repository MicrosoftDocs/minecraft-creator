...
| xz_range | {"max":2,"min":-2} | [Xz Range](#item-components-intrange) item | XZ range from which the entity will try and take blocks from. | 
| y_range | {"max":3,"min":0} | [y Range](#item-components-intrange) item | Y range from which the entity will try and take blocks from. | 
