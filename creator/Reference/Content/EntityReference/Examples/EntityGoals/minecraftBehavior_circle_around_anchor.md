...
| height_above_target_range | {"max":0,"min":0} | [Height Above Target Range](#legacy-floatrange) item | The number of blocks above the target that the next anchor point can be set. | Phantom: `{"min":20,"max":40}` | 
...
| height_offset_range | {"max":0,"min":0} | [Height Offset Range](#legacy-floatrange) item | Vertical distance from the anchor point this entity must stay within, upon a successful height adjustment. | Phantom: `{"min":-4,"max":5}` | 
...
| radius_range | {"max":15,"min":5} | [Radius Range](#legacy-floatrange) item | Horizontal distance from the anchor point this entity must stay within upon a successful radius adjustment. |  | 
