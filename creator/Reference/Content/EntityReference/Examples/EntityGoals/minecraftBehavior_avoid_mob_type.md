...
## Entity Avoid Mob Type Behavior Properties

|Name       |Default Value |Type |Description |Example Values |
|:----------|:-------------|:----|:-----------|:------------- |
| avoid_mob_sound | undefined | [Avoid Mob Sound](#avoid-mob-sound-choices) choices | The sound event to play when the mob is avoiding another mob. |  | 
