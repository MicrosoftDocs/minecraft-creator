...
| ignore_visibility | *not set* | String |  | Phantom: `true` | 
| ignore_visibilty | false | Boolean true/false | Whether or not to ignore direct line of sight while this entity is running away from other specified entities. |  | 
