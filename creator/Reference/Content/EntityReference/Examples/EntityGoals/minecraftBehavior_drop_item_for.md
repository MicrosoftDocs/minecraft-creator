...
| time_of_day_range | {"max":1,"min":0} | [Time Of Day Range](#legacy-floatrange) item | The valid times of day that this goal can be used. For reference: noon is 0.0, sunset is 0.25, midnight is 0.5, and sunrise is 0.75, and back to noon for 1.0. | 
