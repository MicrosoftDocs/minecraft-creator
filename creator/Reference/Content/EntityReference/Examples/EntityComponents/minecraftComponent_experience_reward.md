...
| on_bred (Alternate 1) | *not set* | Key/item pairs of [Bred (Bred)](#bred-bred) items |  |  | 
| on_bred (Alternate 2) | *not set* | Decimal number |  |  | 
| on_bred_array | *not set* | Keyed set of strings |  |  | 
| on_bred_array (Alternate 1) | *not set* | Key/item pairs of [Bred Array (Bred Array)](#bred-array-bred-array) items |  |  | 
...
| on_death (Alternate 1) | *not set* | Key/item pairs of [Death (Death)](#death-death) items |  |  | 
| on_death (Alternate 2) | *not set* | Decimal number |  |  | 
| on_death_array | *not set* | Keyed set of strings |  |  | 
| on_death_array (Alternate 1) | *not set* | Key/item pairs of [Death Array (Death Array)](#death-array-death-array) items |  |  | 
