...
|:----------|:-------------|:----|:-----------|
| filters | *not set* | Minecraft filter | Defines which entities are exceptions and are allowed to be attacked by the owner entity, potentially attacked entity is subject "other". | 
