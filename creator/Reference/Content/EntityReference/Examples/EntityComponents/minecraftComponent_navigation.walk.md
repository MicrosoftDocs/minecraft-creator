...
| can_open_doors | false | Boolean true/false | Tells the pathfinder that it can path through a closed door assuming the AI will open the door | Evocation Illager: `true` | 
...
| can_pass_doors | true | Boolean true/false | Whether a path can be created through a door | Evocation Illager: `true` | 
