...
|:----------|:-------------|:----|:-----------|
| field_of_view | 26 | Decimal number | Defines, in degrees, the width of the field of view for entities looking at the owner entity. | 
...
| scale_fov_by_distance | true | Boolean true/false | When true, the field of view narrows as the distance between the owner entity and the entity looking at it increases. | 
...
| set_target (as Integer number from a list of choices) | *not set* | Integer number from a list of choices | Set to true/false for legacy boolean targeting behavior. | 
