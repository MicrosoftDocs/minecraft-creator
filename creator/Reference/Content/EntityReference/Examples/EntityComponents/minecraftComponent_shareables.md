...
| pickup_limit | -1 | Integer number | Maximum number of this item the mob will pick up during a single goal tick. |  | 
...
| want_amount | -1 | Integer number | Number of this item this entity wants to have. |  | 
