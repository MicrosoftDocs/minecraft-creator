...
`minecraft:collision_box` specifies the boundary of the entity's .

## Parameters

|Name |Default Value  |Type  |Description  |
|---------|---------|---------|---------|
| height | 1.00 | Decimal | Height of the collision box in blocks. A negative value will be assumed to be 0. |
| width | 1.00 | Decimal | Width of the collision box in blocks. A negative value will be assumed to be 0. |
...
- [chest_boatt](../../../../Source/VanillaBehaviorPack_Snippets/entities/chest_boat.md)
