...
author: mammerla
ms.author: mikeam
title: "Entity Documentation - minecraft:wither_target_highest_damage"
description: "Describes the minecraft:wither_target_highest_damage entity component"
ai-usage: ai-assisted
ms.service: minecraft-bedrock-edition
ms.date: 02/11/2025 
---

# Entity Documentation - minecraft:wither_target_highest_damage

Allows the wither to focus its attacks on whichever mob has dealt the most damage to it.


## Entity Wither Target Highest Damage Properties

|Name       |Default Value |Type |Description |
|:----------|:-------------|:----|:-----------|
| control_flags | [] | [Control Flags](#control-flags-choices) choices |  | 
| entity_types | [] | Array of objects | List of entity types the wither takes into account to find who dealt the most damage to it | 
