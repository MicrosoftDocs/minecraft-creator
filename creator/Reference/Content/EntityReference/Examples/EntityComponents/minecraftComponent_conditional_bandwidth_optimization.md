...
|:----------|:-------------|:----|:-----------|:------------- |
| conditional_values | *not set* | Array of [Conditional Values](#conditional-values-item-type) items | The object containing the conditional bandwidth optimization values. | Boat: `[{"max_optimized_distance":0,"max_dropped_ticks":0,"use_motion_prediction_hints":true,"conditional_values":[{"test":"is_moving","subject":"self"}]}]` | 
| default_values | *not set* | Array of [Default Values](#default-values-item-type) items | The object containing the default bandwidth optimization values. |  | 
