...
| allele_range (as Object) | *not set* | [Allele Range](#allele-range) item |  | 
...
| both_allele (as Object) | *not set* | [Both Allele](#both-allele) item |  | 
...
| either_allele (as Object) | *not set* | [Either Allele](#either-allele) item |  | 
...
| hidden_allele (as Object) | *not set* | [Hidden Allele](#hidden-allele) item |  | 
...
| main_allele (as Object) | *not set* | [Main Allele](#main-allele) item |  | 
...
Same structure as [Both Allele](#both-allele).
