...
|:---------|:-----|:---------|:------------|
| player | [target](../CommandTypes/type_selection.md) | Required | Player to send the dialog to. |
| redirectType | redirectlocation | Required |  |
| offerId | [id](../CommandTypes/type_id.md) | Required |  |
...
|:---------|:-----|:------------|
| offerId | [id](../CommandTypes/type_id.md) |  |
| player | [target](../CommandTypes/type_selection.md) | Player to send the dialog to. |
