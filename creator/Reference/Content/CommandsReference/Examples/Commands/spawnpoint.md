...
| spawnPos | [x y z](../CommandTypes/type_position_float.md) | Optional | A `vector` [x y z] of `floats` that defines the player's new spawn point. |
...
| spawnPos | [x y z](../CommandTypes/type_position_float.md) | A `vector` [x y z] of `floats` that defines the player's new spawn point. |
