...
|:---------|:-----|:---------|:------------|
| trackName | [id](../CommandTypes/type_id.md) | Required | Required. A `string` to specify the track to play. Must be a single word such as `record.cat`. |
| volume | [float](../CommandTypes/type_val.md) | Optional | A `float` number to specify the volume of the music track. |
| fadeSeconds | [float](../CommandTypes/type_val.md) | Optional | A `float` number that specifies the duration the track fades in or out. |
...
| Argument | Type | Required | Description |
|:---------|:-----|:---------|:------------|
| volume | [float](../CommandTypes/type_val.md) | Required | A `float` number to specify the volume of the music track. |

## Arguments Reference

| Argument | Type | Description |
|:---------|:-----|:------------|
| fadeSeconds | [float](../CommandTypes/type_val.md) | A `float` number that specifies the duration the track fades in or out. |
| repeatMode | musicrepeatmode | Optional. An `enum` that specifies how the music is played. Must be `play_once` (default) or `loop`. |
| trackName | [id](../CommandTypes/type_id.md) | Required. A `string` to specify the track to play. Must be a single word such as `record.cat`. |
| volume | [float](../CommandTypes/type_val.md) | A `float` number to specify the volume of the music track. |
