...
| intensity | [float](../CommandTypes/type_val.md) | Optional | Optional. Default `0.5`. A `float` that specifies the camera shake intensity with values from [0, 4]. |
| seconds | [float](../CommandTypes/type_val.md) | Optional | Optional. A `float` that specifies how long the camera will shake. Default: `1.0`. |
...
|:---------|:-----|:------------|
| intensity | [float](../CommandTypes/type_val.md) | Optional. Default `0.5`. A `float` that specifies the camera shake intensity with values from [0, 4]. |
...
| seconds | [float](../CommandTypes/type_val.md) | Optional. A `float` that specifies how long the camera will shake. Default: `1.0`. |
