...
| processor_type | *not set* | String | The type of processor. | 
| rules | *not set* | Array of [Rules](#rules) items | Array of processing rules (for 'minecraft:rule' processor type). | 

##### processor_type

The type of processor. Valid values: 'minecraft:rule', 'minecraft:block_ignore', 'minecraft:block_rot', 'minecraft:protected_blocks', 'minecraft:capped', 'minecraft:gravity', 'minecraft:jigsaw_replacement', 'minecraft:blackstone_replace', 'minecraft:nop'.
...
**JSON path:** `minecraft:processor_list > processors > rules > output_state`
