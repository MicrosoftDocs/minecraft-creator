...
**JSON path:** `geometry.[a-zA-Z0-9_.'-:]+`

|Name       |Default Value |Type |Description |
|:----------|:-------------|:----|:-----------|
| bones | *not set* | Array of [Bones](#bones) items |  | 
| bones (as Array of strings) | *not set* | Array of strings |  | 
| cape | *not set* | String |  | 
| debug | *not set* | Boolean true/false |  | 
...
**JSON path:** `geometry.[a-zA-Z0-9_.'-:]+ > bones`

|Name       |Default Value |Type |Description |
|:----------|:-------------|:----|:-----------|
| bind_pose_rotation | *not set* | Array of strings |  | 
| cubes | *not set* | Array of [Cubes](#cubes) items |  | 
| cubes (as Array of strings) | *not set* | Array of strings |  | 
| debug | *not set* | Boolean true/false |  | 
| locators | *not set* | Named set of objects |  | 
| locators (as Keyed set of strings) | *not set* | Keyed set of strings |  | 
...
| texture_meshes (as Array of strings) | *not set* | Array of strings |  | 

##### Cubes

###### Cubes Properties

**JSON path:** `geometry.[a-zA-Z0-9_.'-:]+ > bones > cubes`
...
**JSON path:** `geometry.[a-zA-Z0-9_.'-:]+ > bones > poly_mesh`
...
**JSON path:** `geometry.[a-zA-Z0-9_.'-:]+ > bones > texture_meshes`
