...
author: mammerla
ms.author: mikeam
title: "Visuals Documentation - minecraft:actor_resource_definition.v1.26.0"
description: "Describes the minecraft:actor_resource_definition.v1.26.0 visual element"
...
| animate (as Array of strings) | *not set* | Array of strings |  | 
| animate (as Molang) | *not set* | Molang |  | 
| hide_held_items | *not set* | Molang | Items held by the entity will be hidden if this expression returns anything other than 0.0. This overrides the rendering settings specified by 'enable_attachables'. | 
| initialize | *not set* | Array of strings |  | 
| parent_setup | *not set* | Molang |  | 
| pre_animation | *not set* | Array of strings |  | 
