...
| minecraft:client_biome | *not set* | [Client Biome (Client Biome Definition)](#client-biome-definition) item | A single Client Biome definition, containing rendering or sound settings related to a Biome defined by the game or a behavior pack |  | 
