...
**JSON path:** `minecraft:client_biome`
...
**JSON path:** `minecraft:client_biome > components`
...
**JSON path:** `minecraft:client_biome > components > minecraft:ambient_sounds`
...
**JSON path:** `minecraft:client_biome > components > minecraft:atmosphere_identifier`
...
**JSON path:** `minecraft:client_biome > components > minecraft:biome_music`
...
**JSON path:** `minecraft:client_biome > components > minecraft:color_grading_identifier`
...
**JSON path:** `minecraft:client_biome > components > minecraft:dry_foliage_color`
...
**JSON path:** `minecraft:client_biome > components > minecraft:fog_appearance`
...
**JSON path:** `minecraft:client_biome > components > minecraft:foliage_appearance`
...
**JSON path:** `minecraft:client_biome > components > minecraft:lighting_identifier`
...
**JSON path:** `minecraft:client_biome > components > minecraft:sky_color`
...
**JSON path:** `minecraft:client_biome > components > minecraft:water_appearance`
...
**JSON path:** `minecraft:client_biome > components > minecraft:water_identifier`
...
**JSON path:** `minecraft:client_biome > description`
