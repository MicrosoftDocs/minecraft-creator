...
| anchor_to | *not set* | [Anchor To](#anchor-from-choices) choices | The anchor point on this element used for positioning. | 
...
| font_size | *not set* | [Font Size](#mapping-type-choices) choices | The size of the font for text rendering. | 
| font_type | *not set* | [Font Type](#binding-condition-choices) choices | The font to use for text rendering. | 
...
| orientation | *not set* | [Orientation](#input-mode-condition-choices) choices | The orientation for stack panels, determining the direction children are laid out. | 
...
| text_alignment | *not set* | [Text Alignment](#grid-rescaling-type-choices) choices | The horizontal alignment of text within a label. | 
...
| binding_type | *not set* | [Binding Type](#binding-condition-choices) choices | The type of binding. | 
