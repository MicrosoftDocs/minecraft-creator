...
author: mammerla
ms.author: mikeam
title: "Loot Tables Documentation - minecraft:loot_table"
description: "Describes the minecraft:loot_table loot table component"
...
|:----------|:-------------|:----|:-----------|
| pools | *not set* | Array of [Pools](#loot-pool) items | A list of loot pools. Each pool is rolled independently to select entries. | 
...
| rolls (as Object) | *not set* | [Rolls (Rolls Range)](#rolls-rolls-range) item |  | 
