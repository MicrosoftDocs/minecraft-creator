...
author: mammerla
ms.author: mikeam
title: "Pack Manifest Documentation - minecraft:0_0_packmanifestdocument"
description: "Describes the minecraft:0_0_packmanifestdocument pack manifest"
ai-usage: ai-assisted
ms.service: minecraft-bedrock-edition
ms.date: 02/11/2025 
---

# Pack Manifest Documentation - minecraft:0_0_packmanifestdocument
...
| modules | *not set* | Array of [Modules](#3.0.0.module) items |  | 
| settings | *not set* | Array of strings |  | 
| subpacks | *not set* | Array of [Subpacks](#3.0.0.subpack) items |  | 
...
**JSON path:** `header > pack_optimization_version`
