...
- It cannot define the [`minecraft:random_offset`](../BlockComponents/minecraftBlock_random_offset.md) component in the permutations array, and only vertical direction multi-blocks can use the random offset component.
