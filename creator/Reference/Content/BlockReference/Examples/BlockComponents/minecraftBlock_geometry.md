...
In version 1.21.0 of Minecraft, your geometry model can use a new `uv_rotation` attribute, in 90 degeree increments, to adjust the rotation of how UV textures apply to cube faces. See [the future preview geometry reference](../../../SchemasReference/Schemas/minecraftSchema_geometry_1.21.0.md.md) for more details.
