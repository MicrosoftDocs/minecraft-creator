...
| [minecraft:explosion_resistance](./minecraftBlock_explosion_resistance.md)| Legacy component (format_version < 1.19.40). |
...
| [Item Visual](./minecraftBlock_item_visual.md)| The description identifier of the geometry and material used to render the item of this block. |
...
| [Liquid Detection](./minecraftBlock_liquid_detection.md)| The definitions for how a block behaves when detecting liquid. |
...
| [Redstone Conductivity](./minecraftBlock_redstone_conductivity.md)| The basic redstone properties of a block. |
| [minecraft:redstone_consumer](./minecraftBlock_redstone_consumer.md)| A component describing how a block can consume and potentially propagate a redstone signal. |
...
| [Transformation](./minecraftBlock_transformation.md)| The block's translation, rotation and scale with respect to the center of its world position |
