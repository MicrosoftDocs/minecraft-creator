...
|[minecraft:custom_components](minecraftBlock_custom_components.md)| --| Array| Sets an ordered list of custom component names bound in script to be executed on a block event. Experimental toggles required: Beta APIs.|
