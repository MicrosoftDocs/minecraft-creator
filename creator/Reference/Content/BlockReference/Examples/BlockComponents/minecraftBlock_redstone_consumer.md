...
A component describing how a block can consume and potentially propogate a redstone signal. This component is not availabe for block permutations.
...
|:----------|:-------------|:----|:-----------|:------------- |
| min_power | 0 | Integer number | Optional minimum value for incoming signal stregth. If signal strength is greater than or equal to this value then the 'onRedstoneUpdate' event is sent to Scripts. Defaults to 0 meaning event is always emitted. |  | 
