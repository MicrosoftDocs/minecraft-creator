...
| material_instances | *not set* | Array of objects | The "minecraft:material_instances" component that will be used when rendered inside of another block. Value must have at most 64 items. | 
