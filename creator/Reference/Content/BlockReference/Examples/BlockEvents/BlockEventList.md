...
|[queue_command](minecraftBlock_queue_command.md)|*not set* | JSON Object| queues the trigger of a slash command or a list of slash commands at the end of a tick.|
