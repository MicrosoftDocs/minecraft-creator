...
|:----------|:----------|:----------|:----------|
|[minecraft:aim_collision](BlockComponents/minecraftBlock_aim_collision.md)| false| Boolean/JSON Object| Describes the collision of the block for raycast and its outline. If set to false it disables the collision of the block with entities. |
|[minecraft:block_collision](BlockComponents/minecraftBlock_block_collision.md)| false| Boolean/JSON Object|  Describes the collision of the block with entities and actors. If set to false, it disables the collision of the block with entities.|
