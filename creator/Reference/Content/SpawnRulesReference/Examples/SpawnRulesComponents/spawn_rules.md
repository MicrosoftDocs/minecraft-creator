...
author: mammerla
ms.author: mikeam
title: "Spawn Rules Documentation - minecraft:spawn_rules"
description: "Describes the minecraft:spawn_rules spawn rule component"
...
**JSON path:** `conditions > minecraft:biome_filter`
...
**JSON path:** `conditions > minecraft:brightness_filter`
...
**JSON path:** `conditions > minecraft:spawns_above_block_filter`
...
**JSON path:** `conditions > minecraft:weight`
