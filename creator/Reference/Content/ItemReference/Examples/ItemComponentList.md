...
|[minecraft:use_modifiers](ItemComponents/minecraft_use_modifiers.md)|*not set* | JSON Object| Determines how long an item takes to use in combination with components such as shooter, throwable, or food.|
