...
|[minecraft:food](ItemComponents/minecraft_food.md)|*not set* | JSON Object|  When an item has a food component, it becomes edible to the player. Must have the `minecraft:use_duration` component in order to function properly.|
...
|[minecraft:shooter](ItemComponents/minecraft_shooter.md)|*not set* | JSON Object|  Shooter Item Component. Must have the `minecraft:use_duration` component in order to function properly. In format versions prior to 1.20.10, this component requires the 'Holiday Creator Features' experimental toggle.|
...
|[minecraft:use_modifiers](ItemComponents/minecraft_use_duration.md)|*not set* | JSON Object| Modifies use effects, including how long an item takes to use and the player's speed when used in combination with components like Shooter, Throwable or Food.|
