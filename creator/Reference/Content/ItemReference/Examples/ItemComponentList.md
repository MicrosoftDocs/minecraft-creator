...
|[minecraft:knockback_resistance](ItemComponents/minecraft_knockback_resistance.md)|*not set* | JSON Object| Sets the knockback resistance item component, determining the amount of  knockback resistance that the item has.|
