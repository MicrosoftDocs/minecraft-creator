...
|:----------|:-------------|:----|:-----------|
| attack_critical_hit | *not set* | [Attack Critical Hit](#attack-critical-hit-choices) choices | Sound played when an attack hits and deals critical damage. | 
| attack_hit | *not set* | [Attack Hit](#attack-critical-hit-choices) choices | Sound played when an attack hits. | 
| attack_miss | *not set* | [Attack Miss](#attack-critical-hit-choices) choices | Sound played when an attack misses or deals no damage due to invulnerability. | 

### Attack Critical Hit choices
