...
| attack_hit | *not set* | [Attack Hit](#attack-hit-choices) choices | Sound played when an attack hits. |  | 
| attack_miss | *not set* | [Attack Miss](#attack-miss-choices) choices | Sound played when an attack misses or deals no damage due to invulnerability. |  | 
