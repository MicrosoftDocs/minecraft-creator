...
**JSON path:** `minecraft:water_settings`
...
**JSON path:** `minecraft:water_settings > caustics`
...
**JSON path:** `minecraft:water_settings > description`
...
**JSON path:** `minecraft:water_settings > particle_concentrations`
...
**JSON path:** `minecraft:water_settings > waves`
