...
- [Biome Creature Spawn Probability](#biome-creature-spawn-probability)
- [Biome Humidity](#biome-humidity)
- [Biome Map Tints](#biome-map-tints)
- [Biome Mountain Parameters](#biome-mountain-parameters)
- [Biome Multinoise Generation Rules](#biome-multinoise-generation-rules)
...
- [Biome Village Type](#biome-village-type)
...
**JSON path:** `minecraft:creature_spawn_probability`
...
**JSON path:** `minecraft:mountain_parameters`
...
**JSON path:** `minecraft:mountain_parameters > steep_material_adjustment`
...
**JSON path:** `minecraft:mountain_parameters > steep_material_adjustment > material`
...
**JSON path:** `minecraft:mountain_parameters > top_slide`
...
**JSON path:** `minecraft:multinoise_generation_rules`
...
**JSON path:** `minecraft:overworld_generation_rules`
...
**JSON path:** `minecraft:overworld_height`
...
**JSON path:** `minecraft:replace_biomes`
...
**JSON path:** `minecraft:replace_biomes > replacements`
...
**JSON path:** `minecraft:surface_material_adjustments`
...
**JSON path:** `minecraft:surface_material_adjustments > adjustments`
...
**JSON path:** `minecraft:surface_material_adjustments > adjustments > materials`
...
**JSON path:** `minecraft:village_type`
