...
## Biome JSON File Properties

|Name       |Default Value |Type |Description |
|:----------|:-------------|:----|:-----------|
| format_version | *not set* | String | Version of the JSON schema used by this file | 
| minecraft:biome | *not set* | [Biome](#biome-definition) item | A single biome definition | 
...
**JSON path:** `minecraft:biome > components`
...
**JSON path:** `minecraft:biome > components > minecraft:climate`
...
**JSON path:** `minecraft:biome > components > minecraft:creature_spawn_probability`
...
**JSON path:** `minecraft:biome > components > minecraft:humidity`
...
**JSON path:** `minecraft:biome > components > minecraft:map_tints`
...
**JSON path:** `minecraft:biome > components > minecraft:mountain_parameters`
...
**JSON path:** `minecraft:biome > components > minecraft:mountain_parameters > steep_material_adjustment`

|Name       |Default Value |Type |Description |
|:----------|:-------------|:----|:-----------|
| east_slopes | *not set* | Boolean true/false | Enable for east-facing slopes | 
| material | *not set* | String | Block type use as steep material | 
| material (Material) | *not set* | [Material (Material)](#material-material) item |  | 
| north_slopes | *not set* | Boolean true/false | Enable for north-facing slopes | 
| south_slopes | *not set* | Boolean true/false | Enable for south-facing slopes | 
| west_slopes | *not set* | Boolean true/false | Enable for west-facing slopes | 
...
**JSON path:** `minecraft:biome > components > minecraft:mountain_parameters > steep_material_adjustment > material`
...
**JSON path:** `minecraft:biome > components > minecraft:mountain_parameters > top_slide`
...
**JSON path:** `minecraft:biome > components > minecraft:multinoise_generation_rules`
...
**JSON path:** `minecraft:biome > components > minecraft:overworld_generation_rules`
...
**JSON path:** `minecraft:biome > components > minecraft:overworld_height`
...
**JSON path:** `minecraft:biome > components > minecraft:replace_biomes`
...
**JSON path:** `minecraft:biome > components > minecraft:replace_biomes > replacements`
...
Same structure as [Sea Floor Material (Sea Floor Material)](#sea-floor-material-sea-floor-material).
...
**JSON path:** `minecraft:biome > components > minecraft:surface_material_adjustments`
...
**JSON path:** `minecraft:biome > components > minecraft:surface_material_adjustments > adjustments`
...
**JSON path:** `minecraft:biome > components > minecraft:surface_material_adjustments > adjustments > materials`
...
**JSON path:** `minecraft:biome > components > minecraft:tags`
...
**JSON path:** `minecraft:biome > components > minecraft:village_type`
...
**JSON path:** `minecraft:biome > description`
...
The name of the Biome, used by other features like the '/locate biome' command. Identifiers should only be lowercase. Value must match a regular expression pattern of "^[a-z0-9._%+-]+:[a-z0-9._%+-]+$".
