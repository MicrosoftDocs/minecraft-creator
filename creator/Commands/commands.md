...
| [`/damage`](./commands/damage.md) | Apply damage to the specified entities. See more in the [Damage Command documentation](../Documents/CommandsDamageIntroduction.md). | Game Directors | Yes |
...
| [`/dialogue`](./commands/dialogue.md) | Opens NPC dialogue for a player. See the page on the [Dialogue documentation](../Documents/NPCDialogue.md#dialogue-command) for more information. | Game Directors | Yes |
...
| [`/execute`](./commands/execute.md) | Executes a command on behalf of one or more entities. See more information in the [Popular Commands page](../Documents/CommandsPopularCommands.md#execute) and the [New Execute Syntax page](../Documents/CommandsNewExecute.md). | Game Directors | Yes |
...
| [`/gamemode`](./commands/gamemode.md) | Sets a player&#39;s game mode. See more in the [Popular Commands documentation](../Documents/CommandsPopularCommands.md#gamemode). | Game Directors | Yes |
| [`/gamerule`](./commands/gamerule.md) | Sets or queries a game rule value. See more in the [Popular Commands documentation](../Documents/CommandsPopularCommands.md#gamerule). | Game Directors | No |
...
| [`/locate`](./commands/locate.md) | Finds the nearest specified biome or structure if it exists in the current dimension. Prints an error if it does not. See more in the [Popular Commands documentation](../Documents/CommandsPopularCommands.md#locate). | Game Directors | Yes |
...
| [`/scoreboard`](./commands/scoreboard.md) | Tracks and displays scores for various objectives. See more information about its use in the [Scoreboards Objectives Commands documentation](../Documents/ScoreboardIntroduction.md#scoreboard-objectives-commands) page. | Game Directors | Yes |
...
| [`/structure`](./commands/structure.md) | Saves or loads a structure in the world. See examples of this command in use in the [Structure Blocks documentation](../Documents/StructureBlocksTutorial.md#creating-structures-using-the-structure-command). | Game Directors | Yes |
...
| [`/tickingarea`](./commands/tickingarea.md) | Add, remove, or list ticking areas. See more information in the [Ticking Area documentation](../Documents/TickingAreaCommand.md). | Game Directors | Yes |
| [`/time`](./commands/time.md) | Changes or queries the world&#39;s game time. See more in the [Popular Commands documentation](../Documents/CommandsPopularCommands.md#time-set). | Game Directors | Yes |
...
| [`/weather`](./commands/weather.md) | Sets the weather in the environment. See more in the [Popular Commands documentation](../Documents/CommandsPopularCommands.md#weather). | Game Directors | Yes |
...
| operator | An &#x60;operator&#x60; for scoreboard. See more in the [Scoreboard documentation](../Documents/ScoreboardOperationsTutorial.md). |   |
...
| target |  |   |
| targets | An &#x60;array&#x60; of &#x60;string&#x60; or [&#x60;target selector&#x60;](../Documents/TargetSelectors.md) to identify which player is targeted. |   |
| text | A &#x60;string&#x60; . |   |
...
| [`Item`](./enums/Item.md) | One of the [Minecraft Items available on this page](../Reference/Content/ItemReference/Examples/ItemComponentList.md). | Yes |
