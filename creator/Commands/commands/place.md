...
- `minecraft:sulfur_caves_glow_lichen_cluster_feature`
- `minecraft:overworld_underground_glow_lichen_feature`
- `minecraft:mangrove_swamp_tall_mangrove_tree_feature`
- `minecraft:sulfur_pool_with_potent_sulfur_block_after_surface_feature`
...
- `minecraft:potent_sulfur_block_feature`
...
- `minecraft:sulfur_spring_trail_to_surface_system_snap_to_ceiling_feature`
