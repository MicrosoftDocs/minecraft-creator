...
| query.client_input_type| (EXPERIMENTAL. Enable 'Experimental Molang Features' to use.) Returns either 'mouse', 'touch', 'gamepad', or 'motion_controller' depending on the type of input used by the current client. |
