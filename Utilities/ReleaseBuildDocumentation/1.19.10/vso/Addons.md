...
|:-----------:|:-----------:|:-----------:|:-----------:|
| Boolean| active| True, False| Determines whether the block is active or not |
...
| String| big_dripleaf_tilt| none, unstable, partial_tilt, full_tilt| Determines the tilt state of big dripleaf block |
...
| Integer| candles| 0 - 3| Describes how many extra candles are in the same block space |
...
| String| dripstone_thickness| tip, frustum, base, middle, merge| Determines the type of a pointed dripstone block |
...
| Boolean| item_frame_photo_bit| True, False| Describes if an item frame block has a photo in it |
| Integer| liquid_depth| 0 - 15| Determines the level of liquid blocks |
| Boolean| lit| True, False| Determines if a block is lit or not |
...
| String| wall_connection_type_east| none, short, tall| Determines what kind of connection a wall has to the east |
| String| wall_connection_type_north| none, short, tall| Determines what kind of connection a wall has to the north |
| String| wall_connection_type_south| none, short, tall| Determines what kind of connection a wall has to the south |
| String| wall_connection_type_west| none, short, tall| Determines what kind of connection a wall has to the west |
| Boolean| wall_post_bit| True, False| Determines if a wall should contain a post |
