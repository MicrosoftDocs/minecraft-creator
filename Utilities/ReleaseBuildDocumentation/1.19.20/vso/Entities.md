...
| Boolean| reevaluate_description| false| If true, the mob will stop being targeted if it stops meeting any conditions. |
...
| Trigger| on_start| | Event(s) to run when the goal starts. |
...
| Type| Name| Default Value| Description |
|:-----------:|:-----------:|:-----------:|:-----------:|
| Decimal| cooldown_seconds| 5.00| Time (in seconds) that the goal is on cooldown before it can be used again. |
| Minecraft Filter| filters| | Conditions that need to be met for the behavior to start. |
...
| Type| Name| Default Value| Description |
|:-----------:|:-----------:|:-----------:|:-----------:|
| Decimal| attack| 0.1| Amount of exhaustion applied when attacking. |
| Decimal| damage| 0.1| Amount of exhaustion applied when taking damage. |
| Decimal| heal| 6| Amount of exhaustion applied when healed through food regeneration. |
| Decimal| jump| 0.05| Amount of exhaustion applied when jumping. |
| Decimal| mine| 0.005| Amount of exhaustion applied when mining. |
| Decimal| sprint| 0.01| Amount of exhaustion applied when sprinting. |
| Decimal| sprint_jump| 0.2| Amount of exhaustion applied when sprint jumping. |
| Decimal| swim| 0.01| Amount of exhaustion applied when swimming. |
| Decimal| walk| 0| Amount of exhaustion applied when walking. |
...
| Type| Name| Default Value| Description |
|:-----------:|:-----------:|:-----------:|:-----------:|
| Boolean| emit_flap| false| If true, the `flap` game event will be emitted when the entity moves through air. |
| Boolean| emit_move| true| If true, the `entityMove` game event will be emitted when the entity moves on ground or through a solid. |
| Boolean| emit_swim| true| If true, the `swim` game event will be emitted when the entity moves through a liquid. |
